...
test.beforeAll(async ({ request }) => {
  ...
  for (const path of ["/api/clinical-ai/recordings", "/api/clinical-ai/recordings/synthetic/start", "/api/clinical-ai/recordings/synthetic/upload/init", "/api/clinical-ai/recordings/synthetic/transcriptions", "/api/clinical-ai/transcripts/synthetic/speakers/synthetic/confirm", "/api/clinical-ai/transcript-segments/synthetic/corrections", "/api/clinical-ai/transcripts/synthetic/review"]) expect((await request.post(path, { data: {} })).status()).toBe(401);
  for (const path of ["/api/clinical-ai/local-storage", "/api/clinical-ai/recordings/synthetic/audio-url", "/api/clinical-ai/recordings/synthetic/transcriptions/latest", "/api/clinical-ai/transcripts/synthetic"]) expect((await request.get(path)).status()).toBe(401);
});
