...
### 6.10 Clinical AI *(added post-v2.0)*
Premium, doctor-controlled documentation assistance. AI output is never clinical
authority: every AI result is a candidate that the assigned doctor explicitly
