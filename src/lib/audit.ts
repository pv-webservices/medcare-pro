...
export const AUDIT_ACTIONS = {
  CLINICAL_AI_RUN_COMPLETED: "CLINICAL_AI_RUN_COMPLETED",
  PATIENT_PORTAL_ACTIVATION_CREATED: "PATIENT_PORTAL_ACTIVATION_CREATED",
  PATIENT_PORTAL_ACTIVATION_RESENT: "PATIENT_PORTAL_ACTIVATION_RESENT",
  PATIENT_PORTAL_ACCESS_REVOKED: "PATIENT_PORTAL_ACCESS_REVOKED",
  PATIENT_PORTAL_ACCESS_REENABLED: "PATIENT_PORTAL_ACCESS_REENABLED",
  ...
  PRESCRIPTION_CORRECTION_CREATED: "PRESCRIPTION_CORRECTION_CREATED",
  PRESCRIPTION_ISSUED: "PRESCRIPTION_ISSUED",
  PRESCRIPTION_SUPERSEDED: "PRESCRIPTION_SUPERSEDED",
  ...
  CLINIC_TELEPHONY_HOURS_UPDATED: "CLINIC_TELEPHONY_HOURS_UPDATED",
  CLINIC_IVR_PROFILE_UPDATED: "CLINIC_IVR_PROFILE_UPDATED",
  CLINIC_IVR_PROFILE_RESET: "CLINIC_IVR_PROFILE_RESET",
  CLINIC_TELEPHONY_TEST_CALL_STARTED: "CLINIC_TELEPHONY_TEST_CALL_STARTED",
  TELEPHONY_BOOKING_FOLLOW_UP_RESOLVED:
    "TELEPHONY_BOOKING_FOLLOW_UP_RESOLVED",
  PLIVO_NUMBER_SYNCED: "PLIVO_NUMBER_SYNCED",
  PLIVO_NUMBER_ASSIGNED: "PLIVO_NUMBER_ASSIGNED",
  PLIVO_NUMBER_UNASSIGNED: "PLIVO_NUMBER_UNASSIGNED",
  PLIVO_NUMBER_REASSIGNED: "PLIVO_NUMBER_REASSIGNED",
  PLIVO_NUMBER_QUARANTINED: "PLIVO_NUMBER_QUARANTINED",
  PLIVO_NUMBER_RELEASED: "PLIVO_NUMBER_RELEASED",
  PLIVO_NUMBER_ASSIGNMENT_RESTORED: "PLIVO_NUMBER_ASSIGNMENT_RESTORED",
  PLIVO_NUMBER_QUARANTINE_OVERRIDDEN: "PLIVO_NUMBER_QUARANTINE_OVERRIDDEN",
  PLIVO_NUMBER_PROVIDER_MISMATCH: "PLIVO_NUMBER_PROVIDER_MISMATCH",
  WHATSAPP_PROVIDER_ACCOUNT_CREATED: "WHATSAPP_PROVIDER_ACCOUNT_CREATED",
  WHATSAPP_PROVIDER_ACCOUNT_UPDATED: "WHATSAPP_PROVIDER_ACCOUNT_UPDATED",
  WHATSAPP_DEVICE_CREATED: "WHATSAPP_DEVICE_CREATED",
  WHATSAPP_DEVICE_UPDATED: "WHATSAPP_DEVICE_UPDATED",
  WHATSAPP_ROUTING_UPDATED: "WHATSAPP_ROUTING_UPDATED",
  WHATSAPP_PROVIDER_KEY_REPLACED: "WHATSAPP_PROVIDER_KEY_REPLACED",
  WHATSAPP_PROVIDER_ENABLED: "WHATSAPP_PROVIDER_ENABLED",
  WHATSAPP_PROVIDER_DISABLED: "WHATSAPP_PROVIDER_DISABLED",
  WHATSAPP_PROVIDER_DEVICE_LIMIT_CHANGED: "WHATSAPP_PROVIDER_DEVICE_LIMIT_CHANGED",
  WHATSAPP_DEVICE_QR_INITIATED: "WHATSAPP_DEVICE_QR_INITIATED",
  WHATSAPP_DEVICE_CONNECTED: "WHATSAPP_DEVICE_CONNECTED",
  WHATSAPP_DEVICE_DISCONNECTED: "WHATSAPP_DEVICE_DISCONNECTED",
  WHATSAPP_DEVICE_REMOVED: "WHATSAPP_DEVICE_REMOVED",
  WHATSAPP_WEBHOOK_REGENERATED: "WHATSAPP_WEBHOOK_REGENERATED",
  WHATSAPP_PRIMARY_CHANGED: "WHATSAPP_PRIMARY_CHANGED",
  WHATSAPP_BACKUP_CHANGED: "WHATSAPP_BACKUP_CHANGED",
  WHATSAPP_FAILOVER_CHANGED: "WHATSAPP_FAILOVER_CHANGED",
  WHATSAPP_CLINIC_ASSIGNMENT_CHANGED: "WHATSAPP_CLINIC_ASSIGNMENT_CHANGED",
  /** The Owner set the tenant's plan and/or its feature overrides. */
  TENANT_ENTITLEMENTS_SET: "TENANT_ENTITLEMENTS_SET",
  CLINIC_CAPACITY_REQUESTED: "CLINIC_CAPACITY_REQUESTED",
  CLINIC_CAPACITY_REQUEST_CANCELLED: "CLINIC_CAPACITY_REQUEST_CANCELLED",
  CLINIC_CAPACITY_PAYMENT_CONFIRMED: "CLINIC_CAPACITY_PAYMENT_CONFIRMED",
  CLINIC_CAPACITY_PAYMENT_WAIVED: "CLINIC_CAPACITY_PAYMENT_WAIVED",
  CLINIC_CAPACITY_PAYMENT_FAILED: "CLINIC_CAPACITY_PAYMENT_FAILED",
  CLINIC_CAPACITY_REQUEST_APPROVED: "CLINIC_CAPACITY_REQUEST_APPROVED",
  CLINIC_CAPACITY_REQUEST_REJECTED: "CLINIC_CAPACITY_REQUEST_REJECTED",
  CLINIC_CAPACITY_GRANTED: "CLINIC_CAPACITY_GRANTED",
  CLINIC_CAPACITY_REVOKED: "CLINIC_CAPACITY_REVOKED",
  PLAN_CLINIC_LIMIT_CHANGED: "PLAN_CLINIC_LIMIT_CHANGED",
  TENANT_PLAN_UPGRADE_APPROVED: "TENANT_PLAN_UPGRADE_APPROVED",
