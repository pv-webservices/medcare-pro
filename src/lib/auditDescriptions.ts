...
> = {
  ...
  [AUDIT_ACTIONS.PLIVO_NUMBER_ASSIGNMENT_RESTORED]: { label: "IVR number assignment restored", detail: "A platform owner restored a quarantined number to its previous clinic.", side: "platform", category: "organisation" },
  [AUDIT_ACTIONS.PLIVO_NUMBER_QUARANTINE_OVERRIDDEN]: { label: "IVR number quarantine overridden", detail: "A platform owner released a number before its safety quarantine expired and recorded a reason.", side: "platform", category: "organisation" },
  ...
  [AUDIT_ACTIONS.CLINIC_CAPACITY_REQUESTED]: {
    label: "Clinic capacity requested",
    detail: "An organisation requested additional clinic capacity or a higher plan.",
    side: "tenant",
    category: "entitlements",
  },
  [AUDIT_ACTIONS.CLINIC_CAPACITY_REQUEST_CANCELLED]: {
    label: "Clinic capacity request cancelled",
    detail: "An organisation cancelled an open clinic capacity request.",
    side: "tenant",
    category: "entitlements",
  },
  [AUDIT_ACTIONS.CLINIC_CAPACITY_PAYMENT_CONFIRMED]: {
    label: "Clinic capacity payment confirmed",
    detail: "A Platform Owner confirmed payment without storing payment credentials.",
    side: "platform",
    category: "entitlements",
  },
  [AUDIT_ACTIONS.CLINIC_CAPACITY_PAYMENT_WAIVED]: {
    label: "Clinic capacity payment waived",
    detail: "A Platform Owner waived payment for a clinic capacity request.",
    side: "platform",
    category: "entitlements",
  },
  [AUDIT_ACTIONS.CLINIC_CAPACITY_PAYMENT_FAILED]: {
    label: "Clinic capacity payment needs attention",
    detail: "A Platform Owner marked the submitted payment as unconfirmed.",
    side: "platform",
    category: "entitlements",
  },
  [AUDIT_ACTIONS.CLINIC_CAPACITY_REQUEST_APPROVED]: {
    label: "Clinic capacity request approved",
    detail: "A Platform Owner approved a reviewed clinic capacity request.",
    side: "platform",
    category: "entitlements",
  },
  [AUDIT_ACTIONS.CLINIC_CAPACITY_REQUEST_REJECTED]: {
    label: "Clinic capacity request rejected",
    detail: "A Platform Owner rejected a clinic capacity request with a reason.",
    side: "platform",
    category: "entitlements",
  },
  [AUDIT_ACTIONS.CLINIC_CAPACITY_GRANTED]: {
    label: "Clinic capacity granted",
    detail: "An auditable grant increased an organisation's clinic allowance.",
    side: "platform",
    category: "entitlements",
  },
  [AUDIT_ACTIONS.CLINIC_CAPACITY_REVOKED]: {
    label: "Clinic capacity revoked",
    detail: "A grant stopped contributing to future clinic creation.",
    side: "platform",
    category: "entitlements",
  },
  [AUDIT_ACTIONS.PLAN_CLINIC_LIMIT_CHANGED]: {
    label: "Plan clinic policy changed",
    detail: "A plan's included clinic allowance or add-on pricing changed.",
    side: "platform",
    category: "entitlements",
  },
  [AUDIT_ACTIONS.TENANT_PLAN_UPGRADE_APPROVED]: {
    label: "Plan upgrade approved",
    detail: "A reviewed request moved an organisation to a higher-capacity plan.",
    side: "platform",
    category: "entitlements",
  },
